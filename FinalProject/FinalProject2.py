...
class Paddle:
    ...
    def movePaddle(self, balls):    #AI Handling of the ball movement
        ...
        elif (self.control == "goodAI"):  #If controls should be handled by AI
            orderedBalls = []
...
def main():
    ...
    paddles.append(Paddle(1, GREEN, round(HALF_PAD_WIDTH - 1), round(SCREEN_HEIGHT/2), "goodAI"))      #Paddle 1
    paddles.append(Paddle(2, RED, round(SCREEN_WIDTH + 1 - HALF_PAD_WIDTH), round(SCREEN_HEIGHT/2), "badAI"))    #Paddle 2
